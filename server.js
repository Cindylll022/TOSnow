...
app.post('/api/simplify', async (req, res) => {
    ...
    const prompt = `Simplify the following legal text in 100 words max, and format the result with appropriate HTML tags (such as bulletpoints), bold important information:\n${text}`;
